...
public class MainActivity extends ActionBarActivity implements
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(com.kitefishlabs.soundscapetk.R.menu.main,
				menu);
		return true;
	}
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			switch (position) {
			case 1:
				frag = StatusFragment.newInstance(2);
				break;
			case 2:
				frag = MapFragment.newInstance(3);
				break;
			default:
		...
		public CharSequence getPageTitle(int position) {
			...
			case 0:
				return getString(
						com.kitefishlabs.soundscapetk.R.string.title_main)
						.toUpperCase(l);
			case 1:
				return getString(
						com.kitefishlabs.soundscapetk.R.string.title_status)
						.toUpperCase(l);
			case 2:
				return getString(
						com.kitefishlabs.soundscapetk.R.string.title_map)
						.toUpperCase(l);
			}
			return null;
		}
	...
	public static class MainFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(
					com.kitefishlabs.soundscapetk.R.layout.fragment_main,
					container, false);
			//
			return rootView;
		}
	...
	public static class StatusFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
				Bundle savedInstanceState) {
			View rootView = inflater.inflate(
					com.kitefishlabs.soundscapetk.R.layout.fragment_status,
					container, false);
			//
			return rootView;
		}
		...
		public void updateLatLonReadings(double newLat, double newLon) {
			TextView latview = (TextView) getView().findViewById(
					com.kitefishlabs.soundscapetk.R.id.loc_lat_label);
			latview.setText(String.valueOf(newLat));
			TextView lonview = (TextView) getView().findViewById(
					com.kitefishlabs.soundscapetk.R.id.loc_lon_label);
	...
	public static class MapFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
				Bundle savedInstanceState) {
			View rootView = inflater.inflate(
					com.kitefishlabs.soundscapetk.R.layout.fragment_map,
					container, false);
			...
			case ConnectionResult.SUCCESS:
				...
				mapView = (MapView) rootView
						.findViewById(com.kitefishlabs.soundscapetk.R.id.map);
...
//							.newLatLngZoom(new LatLng(42.72887, -73.683522), 17);
...
//			mapView.onLowMemory();
	...
	public void onConnectionFailed(ConnectionResult connectionResult) {
		...
		if (connectionResult.hasResolution()) {
			 ...
			 * the error.
			 */
			Log.v("onConnectionFailed error code:",
	...
	public void onLocationChanged(Location location) {
		...
		String msg = "Updated Location: " + String.valueOf(lat) + ", "
